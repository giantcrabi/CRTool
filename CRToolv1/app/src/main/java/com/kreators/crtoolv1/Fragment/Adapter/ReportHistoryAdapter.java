 ...
 */
public class ReportHistoryAdapter extends BaseAdapter implements Filterable {

    public Context context;
    public ArrayList<SerialNumber> snArrayList;
    public ArrayList<SerialNumber> orig;

    public ReportHistoryAdapter(Context context, ArrayList<SerialNumber> employeeArrayList) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null) {
            convertView= LayoutInflater.from(context).inflate(R.layout.adapter_report_history, parent, false);
